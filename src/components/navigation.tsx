...
import { BadgeDollarSign, CalendarFold, HandCoins, Home, Landmark, LineChart, LogOut, Menu, Package, Package2, ReceiptText, ShoppingCart, Users, Wrench } from "lucide-react";
    ...
    <header className="sticky top-0 z-10 flex h-14 items-center border-b px-4 h-[60px] px-6">
      {operationalYears.length > 0 &&
        <Select
          ...
          onValueChange={(value) => { window.localStorage.setItem("operationalYear", value) }}
        >
